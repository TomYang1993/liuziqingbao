// Merge classifications from stdin: { "<url>": { relevant, topics, doc_type, summary } }. Marks each as ai:true.
...
for (const it of items) {
  ...
  if (!r) continue;
  if (typeof r.relevant !== 'boolean' || !Array.isArray(r.topics) || !r.topics.every((t) => TOPICS.includes(t)) || !KINDS.includes(r.doc_type) || (r.summary != null && typeof r.summary !== 'string')) {
